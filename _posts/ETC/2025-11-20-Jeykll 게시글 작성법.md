...
last_modified_at: 2026-02-27 12:24:00 +0900
categories: [etc, ]
tags: []
---
...
# 자동으로 소문자 되지 않습니다. -> 규칙: 소문자로 하기

slug: uri-name
# uri에 표시할 이름을 설정할 수 있습니다.
# 규칙: 제목에 한글이 존재하는 경우 slug 설정하기
# 규칙: 제목에 대문자 존재하는 경우 slug 설정하기
---
```
...
#### 인라인 수학 블럭
```
{% raw %}{% include my/math-power.html 
content="something" 
inline=true
%} {% endraw %}
...
- 내용물로 원하는 값을 넣을 수 있음.
- 단, 수식내 수식 중첩은 지원 X.
- ex) {% raw %}{{pow:2|10}} in python is `2 ** 10` {% endraw %}

현재 지원하는 수식
- 제곱: {% raw %}{{pow:BASE|EXP}}{% endraw %}
